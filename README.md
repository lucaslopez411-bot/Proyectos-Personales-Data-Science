...
###🔹 [Predicción de Depresión Estudiantil](.Proyectos en Python/Student_Depresion_Prediction.ipynb)
...
### 🔹 [Predicción de Churn](.Proyectos en Python/Proyecto_DSII_Churn_Clientes_Lopez_Lucas.ipynb)
